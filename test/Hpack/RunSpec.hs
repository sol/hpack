  ...
  describe "renderPackage" $ do
    ...
    context "when rendering internal-libraries section" $ do
      it "includes cabal-version: >= 2.0" $ do
        renderPackage_ package {packageInternalLibraries = Map.singleton "example-foo" (section $ InternalLibrary ["Foo"] [] [])}
        `shouldBe` unlines [
            "name: foo"
          , "version: 0.0.0"
          , "build-type: Simple"
      ...
      it "renders all internal library sections" $ do
        renderPackage_ package {packageInternalLibraries = Map.fromList [("example-foo", section $ InternalLibrary ["Foo"] [] []), ("example-bar", section $ InternalLibrary ["Bar"] [] [])]}
        `shouldBe` unlines [
            "name: foo"
          , "version: 0.0.0"
          , "build-type: Simple"
      ...
      it "includes dependencies" $ do
        renderPackage_ package {packageInternalLibraries = Map.singleton "example-foo" (section $ InternalLibrary ["Foo"] [] []) {sectionDependencies = Dependencies $ Map.fromList
      ...
      it "includes other-modules" $ do
        renderPackage_ package {packageInternalLibraries = Map.singleton "example-foo" (section $ InternalLibrary ["Foo"] ["Bar"] [])}
        `shouldBe` unlines [
            "name: foo"
          , "version: 0.0.0"
          , "build-type: Simple"
      ...
      it "includes reexported-modules" $ do
        renderPackage_ package {packageInternalLibraries = Map.singleton "example-foo" (section $ InternalLibrary ["Foo"] [] ["base:Data.Monoid as Bar"])}
        `shouldBe` unlines [
            "name: foo"
          , "version: 0.0.0"
          , "build-type: Simple"
