...
emptyLibrarySection = LibrarySection Nothing Nothing Nothing Nothing Nothing Nothing Nothing
...
emptyExecutableSection = ExecutableSection Nothing Nothing Nothing
